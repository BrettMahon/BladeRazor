    ...
    public class FormEditTagHelper : FormBaseTagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            foreach (var explorer in For.ModelExplorer.Properties)
            {
                ...
                if (formAttribute?.Type == InputType.Hidden)
                {
        ...
        protected IHtmlContent GenerateContent(ModelExpression f, FormAttribute formAttribute)
        {
            ...
            {
                InputType.TextArea => GenerateTextAreaTagHelper(f, formAttribute.TextAreaRows),
                InputType.Hidden => GenerateHiddenTagHelper(f),
                InputType.Select => GenerateSelectContent(f, formAttribute),
